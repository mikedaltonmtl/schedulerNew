...
describe("Form", () => {
  ...
  it("validates that the student name is not blank", () => {
    ...
    /* Render the Form with interviewers and the onSave mock function passed as an onSave prop,
  ...
  it("validates that the interviewer cannot be null", () => {
    ...
    const { getByText } = render(
      <Form interviewers={interviewers} onSave={onSave} interviewer={null} student="Lydia Miller-Jones" />
    );
    fireEvent.click(getByText("Save"));
